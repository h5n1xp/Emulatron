...
-(void)setupLibNode{
    ...
    uint32_t libIDPtr = namePtr + [self writeString:"mathffp.library" toAddress:namePtr]; //write the name string there and generate the next free address
    self.libName = namePtr; //write the address of the string to the libNode
    
    [self writeString:"mathffp 37.34 (08 Feb 2017)" toAddress:libIDPtr]; //write the ID string to the data area
