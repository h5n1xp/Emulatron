...
-(void)setupLibNode{
    ...
    uint32_t libIDPtr = namePtr + [self writeString:"expansion.library" toAddress:namePtr]; //write the name string there and generate the next free address
    self.libName = namePtr; //write the address of the string to the libNode
    
    [self writeString:"expansion 37.34 (09 Feb 2017)" toAddress:libIDPtr]; //write the ID string to the data area
